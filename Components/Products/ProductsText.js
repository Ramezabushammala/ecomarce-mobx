...
const ProductsText = () => {
  return (
    <div>
      <Row className="mt-2">
        <div className={Styles.cattext}>الالكترونيات :</div>
      </Row>
      <Row>
        <Col md="8">
          <div className={`${Styles.cattitle} d-inline`}>
            آيفون XR بذاكرة سعة 128 جيجابايت ويدعم تقنية 4G LTE مع تطبيق فيس
            تايم (برودكت) أحمر{" "}
            <div className={`${Styles.catrate} d-inline mx-3`}>4.5</div>
          </div>
        </Col>
      </Row>
      <Row>
        <Col md="8" className="mt-4">
          <div className={`${Styles.cattext} d-inline`}>الماركة :</div>
          <div className={`${Styles.barndtext} d-inline mx-1`}>سامسنوج </div>
        </Col>
      </Row>
      <Row>
      ...
      <Row className="mt-4">
        <div className={Styles.cattext}>المواصفات :</div>
      </Row>
      <Row className="mt-2">
        <Col md="10">
          <div className={`${Styles.productdescription} d-inline`}>
      ...
      <Row className="mt-4">
        <Col md="12">
          <div className={`${Styles.productprice} d-inline px-3 py-3 border`}>
            34000 جنية
          </div>
          <div className={`${Styles.productcartadd} px-3 py-3 d-inline mx-3`}>
            اضف للعربة
          </div>
        </Col>
      </Row>
